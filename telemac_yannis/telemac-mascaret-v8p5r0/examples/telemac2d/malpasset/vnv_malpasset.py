...
class VnvStudy(AbstractVnvStudy):
    ...
    def _pre(self):
        ...
        #======================================================================
        # LIPS run
        self.add_study('lips_seq',
                       'telemac2d',
                       't2d_malpasset-lips.cas')
        # parallel mode
        cas = TelemacCas('t2d_malpasset-lips.cas', get_dico('telemac2d'))
        cas.set('PARALLEL PROCESSORS', 4)
        self.add_study('lips_par',
                       'telemac2d',
                       't2d_malpasset-lips_par.cas',
                       cas=cas)
        del cas
    ...
    def _check_results(self):
        ...
        self.check_epsilons('nerd_par:T2DRES',
                            'f2d_malpasset-nerd.slf',
                            eps=[3.5, 3.6, 3.2, 3.2, 1.E-15])
        # Comparison between sequential and parallel run.
        self.check_epsilons('nerd_seq:T2DRES',
                            'nerd_par:T2DRES',
                            eps=[5.1, 3.1, 2.8, 2.8, 1.E-15])

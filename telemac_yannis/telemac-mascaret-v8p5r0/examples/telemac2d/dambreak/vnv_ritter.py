...
class VnvStudy(AbstractVnvStudy):
    ...
    def _pre(self):
        ...
        #======================================================================
        # LIPS run
        self.add_study('lips_seq', 'telemac2d', 't2d_ritter-lips.cas')
        # LIPS run in parallel
        cas = TelemacCas('t2d_ritter-lips.cas', get_dico('telemac2d'))
        cas.set('PARALLEL PROCESSORS', 4)
        self.add_study('lips_par', 'telemac2d', 't2d_ritter-lips_par.cas', cas=cas)
        del cas
    ...
    def _check_results(self):
        ...
        self.check_epsilons('lips_seq:T2DRES', 'f2d_ritter-lips.slf', eps=[1e-15])
        self.check_epsilons('lips_par:T2DRES', 'f2d_ritter-lips.slf', eps=[1e-11])
        self.check_epsilons('lips_seq:T2DRES', 'lips_par:T2DRES', eps=[1.e-11])
    ...
    def _post(self):
        ...
        for idx, record in enumerate(records):
            time_label = '$t$ = {:.2f} s'.format(kin1_res.times[record])
        ...
        vnv_plotbar(\
            ...
            x_labels=res_labels,
            y_scale='linear',
            fig_title='Minimum values of water depth (m)',
        ...
        vnv_plotbar(\
            ...
            x_labels=res_labels,
            y_scale='linear',
            fig_title='Maximum values of water depth (m)',

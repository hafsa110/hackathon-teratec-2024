...
class VnvStudy(AbstractVnvStudy):
    ...
    def _pre(self):
        ...
        #======================================================================
        # LIPS run
        self.add_study('lips_seq', 'telemac2d', 't2d_stoker-lips.cas')
        # LIPS run in parallel
        cas = TelemacCas('t2d_stoker-lips.cas', get_dico('telemac2d'))
        cas.set('PARALLEL PROCESSORS', 4)
        self.add_study('lips_par', 'telemac2d', 't2d_stoker-lips_par.cas', cas=cas)
        del cas

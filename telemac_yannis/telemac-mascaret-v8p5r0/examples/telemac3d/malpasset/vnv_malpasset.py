...
class VnvStudy(AbstractVnvStudy):
    ...
    def _post(self):
        ...
        RFO4 = self.get_study_file('vnv_8:T3DRFO')
        P_RFO1 = self.get_study_file('vnv_2:T3DRFO')
        P_RFO2 = self.get_study_file('vnv_4:T3DRFO')
        P_RFO3 = self.get_study_file('vnv_6:T3DRFO')
        P_RFO4 = self.get_study_file('vnv_8:T3DRFO')

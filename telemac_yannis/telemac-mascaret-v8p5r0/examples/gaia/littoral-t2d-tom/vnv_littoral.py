...
class VnvStudy(AbstractVnvStudy):
    ...
    def _pre(self):
        ...
        self.add_study('vnv_3',
                       'telemac2d',
                       't2d_littoral_surfRol.cas')

        # littoral T2D+TOM+GAI scalar mode
        cas = TelemacCas('t2d_littoral_surfRol.cas', get_dico('telemac2d'))
        cas.set('PARALLEL PROCESSORS', 4)

        self.add_study('vnv_4',
                       'telemac2d',
                       't2d_littoral_surfRol_par.cas',
                       cas=cas)
    ...
    def _check_results(self):
        ...
        # Comparison of time series files
        self.check_epsilons('vnv_1:WACHI2',
                            'ref_tom_hist.slf',
                            eps=[1.E-9])

        self.check_epsilons('vnv_2:WACHI2',
                            'ref_tom_hist.slf',
                            eps=[1.E-9])

        self.check_epsilons('vnv_1:T2DHI1',
                            'ref_t2d_hist.slf',
                            eps=[1.E-9])

        self.check_epsilons('vnv_2:T2DHI1',
                            'ref_t2d_hist.slf',
                            eps=[1.E-9])

        self.check_epsilons('vnv_1:GAIHI2',
                            'ref_gai_hist.slf',
                            eps=[1.E-9])

        self.check_epsilons('vnv_2:GAIHI2',
                            'ref_gai_hist.slf',
                            eps=[1.E-9])
        ...
        self.check_epsilons('vnv_3:WACRES',
                            'fom_littoral_surfRol.slf',
                            eps=[1.E-9, 361., 1.E-9, 1.E-9, 1.E-9, 1.E-9, 2.E-9, 4.E-9, 1.E-9, 1.E-9, 1.E-9])
        ...
        self.check_epsilons('vnv_3:WACRES',
                            'vnv_4:WACRES',
                            eps=[1.E-9, 361., 1.E-9, 1.E-9, 1.E-9, 1.E-9, 1.E-9, 1.E-9, 1.E-9, 1.E-9, 1.E-9])

...
\begin{equation}
\displaystyle \frac{\partial{AC}}{\partial{t}}+\frac{\partial{QC}}{\partial{x}}=\displaystyle\frac{\partial{}}{\partial{x}}\left(Ak\frac{\partial{C}}{\partial{x}}\right)+AS=\displaystyle\frac{\partial{}}{\partial{x}}\left(Ak\frac{\partial{C}}{\partial{x}}\right)+AS_{v}+A\frac{q_{s}-q_{f}}{h}
\end{equation}
...
\begin{equation}
\displaystyle \frac{\partial{AC}}{\partial{t}}+\frac{\partial{QC}}{\partial{x}}=\displaystyle\frac{\partial{}}{\partial{x}}\left(Ak\frac{\partial{C}}{\partial{x}}\right)+AS=\displaystyle\frac{\partial{}}{\partial{x}}\left(Ak\frac{\partial{C}}{\partial{x}}\right)+A\left( S_{v}+S_{v}^{c}+\frac{S_{s}^{c}}{h}+\frac{S_{s}}{h}\right)
\end{equation}

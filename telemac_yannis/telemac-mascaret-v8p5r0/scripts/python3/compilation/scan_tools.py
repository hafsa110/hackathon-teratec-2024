...
def get_scan_content(fle, root, bypass):
    ...
    Optionally, the [general] section can also include reference to other
    cmdf file, considered as external, with their own compilation options.
     - external: passive.solve, or the name of a module defined in the cfg
    ...
    [bief]
     ...
     - files: bief_def.f
         bief.f
         ...
         the list of files included in the tree for calls that are in the path,
    ...
    try:
        ...
        raise TelemacException(
            ...
            f' cmdf-scan file: {fle}\n'
            f'     ... you may have to use the --rescan option\n{exception}')

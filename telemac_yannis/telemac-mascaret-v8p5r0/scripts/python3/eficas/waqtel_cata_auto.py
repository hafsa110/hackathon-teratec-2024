...
#       -----------------------------------
        WATER_SALINITY = SIMP(statut ='f',
#       -----------------------------------
            typ = 'R',
            defaut = [35.],
            fr = """Salinite moyenne de l eau necessaire pour calculer les valeurs
de $C_s$.""",
            ang = """Mean salinity necessary for computing different values of $C_s$.""",
        ),
#       -----------------------------------
        O2 = FACT(statut='o',
#       -----------------------------------
...
#           -----------------------------------
                typ = 'TXM',
                into = ["CONSTANT","ELMORE AND HAYES","MONTGOMERY","BENSON AND KRAUSE (1984)"],
                defaut = ["CONSTANT"],
...
\item 3 : formule de Benson \& Krause (1984).
\end{itemize}
Pour EUTRO+O2.""",
...
\item 3: Benson \& Krause formula (1984).
\end{itemize}
For EUTRO+O2.""",
            ),
        ),
...
#       -----------------------------------
            typ = 'R',
            defaut = 0.97,
            fr = """Variable $e_{\rm{air}}$ en 2D or (1-$alb_{lw}$) en 3D dans la
documentation.
Pour THERMIC seulement.""",
            ang = """Variable $e_{\rm{air}}$ in 2D or (1-$alb_{lw}$) in 3D in the
documentation.
For THERMIC only.""",
        ),
#       -----------------------------------

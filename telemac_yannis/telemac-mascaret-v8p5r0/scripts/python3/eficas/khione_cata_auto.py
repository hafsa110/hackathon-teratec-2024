...
#       -----------------------------------
            typ = 'TXM',
            into = ["DALY (1984)","SVENSSON & OMSTEDT (1994)","MATOUSEK (1992)","GOSIK & OSTERKAMP (1983)","MORSE & RICHARD (2009)"],
            defaut = ["SVENSSON & OMSTEDT (1994)"],
            fr = """""",
            ang = """""",
        ),
#       -----------------------------------
...
#           -----------------------------------
                typ = 'R',
                defaut = [1.E13],
                fr = """En km, visibilite lorsque celle-ci n est pas deja donnee
dans un des fichiers meteo.""",
                ang = """In km, visibility used when it is not already provided

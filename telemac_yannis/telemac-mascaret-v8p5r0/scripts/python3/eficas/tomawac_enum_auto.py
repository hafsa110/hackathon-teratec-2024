...
'VARIABLES_FOR_2D_GRAPHIC_PRINTOUTS' : {
    ...
    'SRE':"Surface roller energy  (m3/s2)",
    'DBR':"Wave breaking dissipation  (m2/s)",
    'DSR':"Surface roller dissipation  (m3/s3)",
  },
}
TelemacdicoFr = {
'WIND_GENERATION' : {
...
'VARIABLES_FOR_2D_GRAPHIC_PRINTOUTS' : {
    ...
    'SRE':"Energie de rouleau (m3/s2)",
    'DBR':"Dissipation par deferlement (m2/s)",
    'DSR':"Surface roller dissipation  (m3/s3)",
  },
}
...
DicoCasFrToCata = {
  ...
  "NOMBRE DE SOUS-PAS DE TEMPS POUR LE ROULEAU":"NUMBER_OF_SURFACE_ROLLER_TIME_STEPS",
  ...
  "ROLLERS SURFACE":"SURFACE_ROLLERS",
  "BETA S ROLLERS SURFACE":"BETA_S_SURFACE_ROLLERS",
  "BETA 2 ROLLERS SURFACE":"BETA_2_SURFACE_ROLLERS",
  ...
  "FICHIER DES SERIES TEMPORELLES":"TIME_SERIES_FILE",
  "FORMAT DU FICHIER DES SERIES TEMPORELLES":"TIME_SERIES_FILE_FORMAT",
...
DicoCasEnToCata = {
  ...
  'NUMBER OF SURFACE ROLLER TIME STEPS':'NUMBER_OF_SURFACE_ROLLER_TIME_STEPS',
  ...
  'SURFACE ROLLERS':'SURFACE_ROLLERS',
  'BETA S SURFACE ROLLERS':'BETA_S_SURFACE_ROLLERS',
  'BETA 2 SURFACE ROLLERS':'BETA_2_SURFACE_ROLLERS',
  'TIME STEP':'TIME_STEP',
  ...
  'TIME SERIES FILE':'TIME_SERIES_FILE',
  'TIME SERIES FILE FORMAT':'TIME_SERIES_FILE_FORMAT',

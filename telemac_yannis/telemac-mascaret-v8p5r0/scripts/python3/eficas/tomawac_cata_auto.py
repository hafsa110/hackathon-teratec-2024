...
#           -----------------------------------
                typ = 'TXM', min=0, max='**',
                into = ["Total variance  (m2)","Spectral significant wave height  (m)","Mean wave direction  (deg)","Mean directional spreading  (deg)","Sea bottom level  (m)","Water depth  (m)","Current along X  (m/s)","Current along Y  (m/s)","Wind along X  (m/s)","Wind along Y  (m/s)","Driving force along X  (m/s2)","Driving force along Y  (m/s2)","Radiation stress along xx  (m3/s2)","Radiation stress along yy  (m3/s2)","Radiation stress along xy  (m3/s2)","Bottom celerity  (m/s)","Wave power (per meter along wave crest)  (kW/m)","Mean frequency FMOY  (Hz)","Mean frequency FM01  (Hz)","Mean frequency FM02  (Hz)","Discrete peak frequency  (Hz)","Peak frequency by Read method of order 5  (Hz)","Peak frequency by Read method of order 8  (Hz)","Surface friction velocity u*  (m/s)","Surface drag coefficient CD  (-)","Surface roughness length Z0  (m)","Surface wave stress  (kg/(m.s2))","Mean period Tmoy  (s)","Mean period Tm01  (s)","Mean period Tm02  (s)","Discrete peak period  (s)","Peak period by Read method of order 5  (s)","Peak period by Read method of order 8  (s)","Private table  (?)","Breaking waves rate (-)","White capping rate  (-)","Surface roller energy  (m3/s2)","Wave breaking dissipation  (m2/s)","Surface roller dissipation  (m3/s3)"],
...
SRE  : Energie de rouleau
DBR  : Dissipation par deferlement
DSR  : Dissipation par rouleau
**Mots-cles associes :**
...
\item BETA : Breaking waves rate
\item BETAWC : White Capping rate
\item SRE  : Surface roller Energy
\item DBR  : Wave breaking dissipation
\item DSR  : Surface roller dissipation
\end{itemize}
...
#       -----------------------------------
        SURFACE_ROLLERS = SIMP(statut ='f',
#       -----------------------------------
            typ = bool,
            defaut = False,
            fr = """Translate to the laguange of Moliere""",
            ang = """Switches surface rollers on""",
        ),
#       -----------------------------------
        TITLE = SIMP(statut ='f',
#       -----------------------------------
...
#   -----------------------------------
    SURFACE_ROLLER = FACT(statut='o',
#   -----------------------------------
#       -----------------------------------
        NUMBER_OF_SURFACE_ROLLER_TIME_STEPS = SIMP(statut ='o',
#       -----------------------------------
            typ = 'I',
            defaut = 1,
            fr = """Nombre de sous pas de temps pour l energie de rouleau""",
            ang = """Number of time steps for surface rollers.""",
        ),
#       -----------------------------------
        BETA_S_SURFACE_ROLLERS = SIMP(statut ='o',
#       -----------------------------------
            typ = 'R',
            defaut = 0.1D0,
            fr = """Parametre beta\_s pour le calcul de la dissipation par rouleau""",
            ang = """Beta\_s parameter to influence the
dissipation of surface rollers""",
        ),
#       -----------------------------------
        BETA_2_SURFACE_ROLLERS = SIMP(statut ='o',
#       -----------------------------------
            typ = 'R',
            defaut = 1.0D0,
            fr = """Parametre Beta\_2 pour le calcul de la dissipation par rouleau""",
            ang = """Beta\_2 parameter to influence the
dissipation of surface rollers""",
        ),
    ),
#   -----------------------------------

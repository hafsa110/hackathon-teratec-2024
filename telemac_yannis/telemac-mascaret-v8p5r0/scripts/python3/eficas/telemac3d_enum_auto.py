...
'VARIABLES_FOR_3D_GRAPHIC_PRINTOUTS' : {
    ...
    'CSO2':"oxygen saturation concentration (mgO2/l)",
    'O2SAT':"percentage of oxygen saturation (\%)",
  },
'VARIABLES_FOR_2D_GRAPHIC_PRINTOUTS' : {
    ...
    'CSO2':"depth averaged oxygen saturation concentration (mgO2/l)",
    'O2SAT':"depth averaged percentage of oxygen saturation (\%)",
  },
...
'OPTION_FOR_SOFT_BOUNDARIES' : {
    0:"Not a soft boundary",
    1:"Method 1. Proportional to the speed",
    2:"Method 2. Proportional to the square of speed",
  },
'MATRIX_STORAGE' : {
    1:"classical EBE",
...
'VARIABLES_FOR_3D_GRAPHIC_PRINTOUTS' : {
    ...
    'CSO2':"concentration de saturation en oxygene (mgO2/l)",
    'O2SAT':"pourcentage de saturation en oxygene (\%)",
  },
'VARIABLES_FOR_2D_GRAPHIC_PRINTOUTS' : {
    ...
    'CSO2':"concentration de saturation en oxygene moyenne (mgO2/l)",
    'O2SAT':"pourcentage de saturation en oxygene moyen (\%)",
  },
'SPATIAL_PROJECTION_TYPE' : {
...
'OPTION_FOR_SOFT_BOUNDARIES' : {
    0:"Pas une frontiere douce",
    1:"Methode 1. Proportionnel a la vitesse",
    2:"Methode 2. Proportionnel au carre de la vitesse",
  },
'MATRIX_STORAGE' : {
    1:"EBE classique",
...
DicoCasFrToCata = {
  ...
  "FICHIER DE COORDONNEES DES SERIES TEMPORELLES":"TIME_SERIES_COORDINATES_FILE",
  ...
  "FICHIER DES SERIES TEMPORELLES 2D":"ED_TIME_SERIES_FILE",
  "FORMAT DU FICHIER DES SERIES TEMPORELLES 2D":"ED_TIME_SERIES_FILE_FORMAT",
  "FICHIER DES SERIES TEMPORELLES 3D":"RD_TIME_SERIES_FILE",
  "FORMAT DU FICHIER DES SERIES TEMPORELLES 3D":"RD_TIME_SERIES_FILE_FORMAT",
  ...
  "OPTION POUR LES FRONTIERES DOUCES":"OPTION_FOR_SOFT_BOUNDARIES",
  "COEFFICIENT POUR LES FRONTIERES DOUCES":"COEFFICIENT_FOR_SOFT_BOUNDARIES",
  ...
  "VITESSES DANS BASE BINAIRE 2 DE DONNEES DE MAREE":"VELOCITIES_IN_BINARY_DATABASE_2_FOR_TIDE",
  ...
  "PRESSION ATMOSPHERIQUE AUX FRONTIERES A MAREE":"ATMOSPHERIC_PRESSURE_AT_TIDAL_BOUNDARIES",
...
DicoCasEnToCata = {
  ...
  'TIME SERIES COORDINATES FILE':'TIME_SERIES_COORDINATES_FILE',
  ...
  '2D TIME SERIES FILE':'ED_TIME_SERIES_FILE',
  '2D TIME SERIES FILE FORMAT':'ED_TIME_SERIES_FILE_FORMAT',
  '3D TIME SERIES FILE':'RD_TIME_SERIES_FILE',
  '3D TIME SERIES FILE FORMAT':'RD_TIME_SERIES_FILE_FORMAT',
  ...
  'OPTION FOR SOFT BOUNDARIES':'OPTION_FOR_SOFT_BOUNDARIES',
  'COEFFICIENT FOR SOFT BOUNDARIES':'COEFFICIENT_FOR_SOFT_BOUNDARIES',
  ...
  'VELOCITIES IN BINARY DATABASE 2 FOR TIDE':'VELOCITIES_IN_BINARY_DATABASE_2_FOR_TIDE',
  ...
  'ATMOSPHERIC PRESSURE AT TIDAL BOUNDARIES':'ATMOSPHERIC_PRESSURE_AT_TIDAL_BOUNDARIES',
...
'ED_TIME_SERIES_FILE_FORMAT':{
  "SERAFIN":"SERAFIN",
  "SERAFIND":"SERAFIND",
  "MED":"MED",
},

'RD_TIME_SERIES_FILE_FORMAT':{
  "SERAFIN":"SERAFIN",
  "SERAFIND":"SERAFIND",
  "MED":"MED",
},

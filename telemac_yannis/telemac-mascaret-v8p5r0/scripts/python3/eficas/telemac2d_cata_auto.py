...
#           -----------------------------------
            TIME_SERIES_COORDINATES_FILE_1 = SIMP(statut ='o',
#           -----------------------------------
                typ = ('Fichier','All Files (*)'),
                defaut = '',
...
\telkey{FICHIER DES SERIES TEMPORELLES 1}.""",
                ang = """Name of the file containing points coordinates and periods of time
where time series are extracted in the \telkey{TIME SERIES FILE 1}.""",
            ),
#           -----------------------------------
            TIME_SERIES_COORDINATES_FILE_2 = SIMP(statut ='o',
#           -----------------------------------
                typ = ('Fichier','All Files (*)'),
                defaut = '',
                fr = """Nom du fichier contenant les coordonnees des points et les intervalles
de temps ou les series temporelles sont extraites dans le
\telkey{FICHIER DES SERIES TEMPORELLES 2}.""",
                ang = """Name of the file containing points coordinates and periods of time
where time series are extracted in the \telkey{TIME SERIES FILE 2}.""",
            ),
        ),
#       -----------------------------------
...
gradient ;
\item TAU\_S : contrainte dans le sens du courant (N/m$^2$) ;
\item 1/R : inverse du rayon de courbure local (1/m) ;
\item OMEGA : vorticite (1/s) ;
\item WDIST : distance au mur le plus proche (m) ;
\item ZRL : niveau de reference pour Nestor (m) ;
...
\item TAU\_S: streamwise stress (N/m$^2$),
\item 1/R: reverse of local radius of curvature (1/m),
\item OMEGA: vorticity (1/s),
...
#           -----------------------------------
            TIME_SERIES_FILE_1 = SIMP(statut ='o',
#           -----------------------------------
                typ = ('Fichier','All Files (*)','Sauvegarde'),
                defaut = '',
                fr = """Nom du fichier dans lequel les series temporelles 2D sont ecrites
aux points definis dans le
\telkey{FICHIER DE COORDONNEES DES SERIES TEMPORELLES 1}.""",
                ang = """Name of the file into which 2D time series are written at the points
defined in the \telkey{TIME SERIES COORDINATES FILE 1}.""",
            ),
#           -----------------------------------
            TIME_SERIES_FILE_1_FORMAT = SIMP(statut ='o',
#           -----------------------------------
                typ = 'TXM',
                into = ['SERAFIN','SERAFIND','MED'],
                defaut = 'SERAFIN',
                fr = """Format du \telkey{FICHIER DES SERIES TEMPORELLES 1}.
Les valeurs possibles sont :
\begin{itemize}
\item SERAFIN : format standard simple precision pour \tel ;
\item SERAFIND: format standard double precision pour \tel ;
\item MED     : format MED double precision base sur HDF5.
\end{itemize}""",
                ang = """Format of the \telkey{TIME SERIES FILE 1}. Possible choices are:
\begin{itemize}
\item SERAFIN : classical single precision format in \tel,
\item SERAFIND: classical double precision format in \tel,
\item MED     : MED double precision format based on HDF5.
...
#           -----------------------------------
            TIME_SERIES_FILE_2 = SIMP(statut ='o',
#           -----------------------------------
                typ = ('Fichier','All Files (*)','Sauvegarde'),
                defaut = '',
                fr = """Nom du fichier dans lequel les series temporelles 2D sont ecrites
aux points definis dans le
\telkey{FICHIER DE COORDONNEES DES SERIES TEMPORELLES 2}.""",
                ang = """Name of the file into which 2D time series are written at the points
defined in the \telkey{TIME SERIES COORDINATES FILE 2}.""",
            ),
#           -----------------------------------
            TIME_SERIES_FILE_2_FORMAT = SIMP(statut ='o',
#           -----------------------------------
                typ = 'TXM',
                into = ['SERAFIN','SERAFIND','MED'],
                defaut = 'SERAFIN',
                fr = """Format du \telkey{FICHIER DES SERIES TEMPORELLES 2}.
Les valeurs possibles sont :
\begin{itemize}
\item SERAFIN : format standard simple precision pour \tel ;
\item SERAFIND: format standard double precision pour \tel ;
\item MED     : format MED double precision base sur HDF5.
\end{itemize}""",
                ang = """Format of the \telkey{TIME SERIES FILE 2}. Possible choices are:
\begin{itemize}
\item SERAFIN : classical single precision format in \tel,
\item SERAFIND: classical double precision format in \tel,
\item MED     : MED double precision format based on HDF5.
...
#   -----------------------------------
        typ = 'TXM', min=0, max='**',
        into = ['TOMAWAC','TOMAWAC2','WAQTEL','KHIONE','GAIA','DELWAQ',''],
        defaut = '',
...
\item TOMAWAC2: internal coupling with \tomawac, meshes and domains can
be different,

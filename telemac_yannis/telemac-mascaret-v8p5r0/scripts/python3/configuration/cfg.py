"""
Provide a class to manage a build configuration.
"""
import configparser
import re
import shutil
...
from configuration.config_tools import (add_externals, get_externals,
                                        get_files_validation_telemac,
                                        get_folders_modules_telemac, get_tags,
                                        parse_user_modules)
...
class Config():
    """
    Class used to manage all information related to a build configuration
    """
    def __init__(self):
        self.general = None
        self.configs = None

...
from compilation.check_code import check_code
...
def compute_config(rescan, bypass):
    """
    Update the configuration with the information needed by compile_telemac.py
...
def main():
    """ Main function of compile_telemac.py """
...
Work with all active configurations.
    ...
    parser.add_argument(
        ...
        help="specify the list modules . separated, "
    ...
    parser.add_argument(
        ...
        help="Check the syntax of Fortran code ")

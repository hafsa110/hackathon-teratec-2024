...
def add_hpc_argument(parser, module=None):
    ...
    parser.add_argument(
        "--email",
        dest="email", default='',
        help="specify an e-mail address to notify when an HPC job is finished")
    parser.add_argument(
        "--project",
...
def main(module=None):
    ...
    @param module (string): the name of the module to run (
      ...
      gaia, khione, postel3d, stbtel and waqtel)
...
# >>> Check whether the config has been compiled for the runcode

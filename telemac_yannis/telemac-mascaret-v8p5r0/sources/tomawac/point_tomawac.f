...
!
      ...
      USE SURFACE_ROLLER, ONLY : FROL, DISSIP_ROL
!
...
!
      ...
      IF(INCLUS(COUPLING,'TOMAWACT3D')) THEN
        ...
        CALL BIEF_ALLVEC(1, STRA42, 'STRA42', NPOIN2*(NPLAN_T3D+1)*NF,
     &                   1, 0, MESH)
      ENDIF
!
...
!     37: SURFACE ROLLER ENERGY
      CALL ADDBLO(VARSOR,FROL)
!     38: BREAKING DISSIPATION
      CALL ADDBLO(VARSOR,DISSIP_BREAK)
!     39: ROLLER DISSIPATION
...
!     ENERGY DISSIPATION DUE TO BREAKING WAVES
      CALL BIEF_ALLVEC(1,DISSIP_BREAK ,'DISBRE',IELM2 , 1 , 2 ,MESH)
      DISSIP_BREAK%R = 0.D0
...
!                                                       WAC2
      ! TODO SOMETHING FOR QUASI BUBBLE DISCRETISATION
        ...
        CALL BIEF_ALLVEC(1,SURFROL_TEL ,  'SRFTEL',IELM2 , 1 , 2 ,MESH)
        CALL BIEF_ALLVEC(1,SURFDIS_TEL ,  'SRDTEL',IELM2 , 1 , 2 ,MESH)
        ...
        IF (COPGAI_TEL) THEN
          ...
          !surface rollers
          !surface rollers is always send to TELEMAC,
          ! because it can not be checked in point telemac2d whether surface rollers exist in tomawac
          ! as point_telemac2d is called before lecdon_tomawac
          SURFROL_TEL%R = 0.D0
          SURFDIS_TEL%R = 0.D0
          CALL ADDBLO(TOM2TEL,SURFROL_TEL)
          CALL ADDBLO(TOM2TEL,SURFDIS_TEL)
        ENDIF
        IF (COUROU_TEL) THEN

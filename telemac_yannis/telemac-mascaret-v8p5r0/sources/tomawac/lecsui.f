...
!
     ...
     & NAMEWX, NAMEWY, TEXVEB, UNITVEB, PHASVEB, FMTVEB, FMTVEF, LUVEB,
     &     LUVEF, INDIV, VENSTA, NVWIN,
     & NAMEU, NAMEV, NAMEH, TEXCOB, UNITCOB, PHASCOB, FMTCOB, LUCOB, 
     &     NAMCOB, NVCOU,  INDIC,
     & NAMMAB, LUMAB, FMTMAB, TEXMAB, UNITMAB, PHASMAB, NVHMA, INDIM
...
!       SETS TRIPLETS U,V,TV1 AND 2 TO UV,VV,AT
     ...
     &              NPOIN2, LUMAB, FMTMAB, AT,TM1,TM2,

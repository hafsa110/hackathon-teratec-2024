...
!
        IF(CPL_GAIA) THEN
          CALL BIEF_OPEN_FILES(CODE5,INST%GAI_FILES,
     &                         INST%MAXLU_GAI,
     &                         PATH,NCAR,
     &                         5,.TRUE.)
!
...
!
      !~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      !>@brief Run a timestep in telemac2d only writing a restart field
      !~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      !>@param[in,out] INST The instance
      !>@param[out] IERR 0 if subroutine successfull,
      !!                        error id otherwise
      !~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
      SUBROUTINE RUN_TIMESTEP_RST_T2D_D(INST,IERR)
!
        TYPE(INSTANCE_T2D), INTENT(INOUT) :: INST
        INTEGER,            INTENT(OUT) :: IERR
!
        IERR = 0
!
        CALL TELEMAC2D(PASS=3,ATDEP=0.D0,NITER=INST%LT,
     &                 CODE='       ',NITERORI=NIT_ORI)
      END SUBROUTINE RUN_TIMESTEP_RST_T2D_D
!
      !~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

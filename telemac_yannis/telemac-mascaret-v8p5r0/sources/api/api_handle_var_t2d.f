...
!
        ...
        ELSE IF(TRIM(VARNAME).EQ.'MODEL.WATERDEPTHN') THEN
          VALEUR = INST%HN%R(INDEX1)            
...
!
     ...
     &        INST%MESH%YNEBOR%R(1:INST%MESH%YNEBOR%DIM1)
        ...
        ELSE IF(TRIM(VARNAME).EQ.'MODEL.WATERDEPTHN') THEN
          VALEUR(1:INST%HN%DIM1) = INST%HN%R(1:INST%HN%DIM1)   
        ELSE IF(TRIM(VARNAME).EQ.'MODEL.INCWATERDEPTH') THEN
     ...
     &       INST%AM1%D%R(1:SIZE(INST%AM1%D%R))
        ELSE IF(TRIM(VARNAME).EQ.'MODEL.AM1X') THEN
          VALEUR(1:INST%AM1%X%DIM1*INST%AM1%X%DIM2) =
     &       INST%AM1%X%R(1:INST%AM1%X%DIM1*INST%AM1%X%DIM2)
     ...
     &       INST%AM2%D%R(1:SIZE(INST%AM2%D%R))
        ELSE IF(TRIM(VARNAME).EQ.'MODEL.AM2X') THEN
          VALEUR(1:INST%AM2%X%DIM1*INST%AM2%X%DIM2) =
     &       INST%AM2%X%R(1:INST%AM2%X%DIM1*INST%AM2%X%DIM2)
     ...
     &       INST%AM3%D%R(1:SIZE(INST%AM3%D%R))
        ELSE IF(TRIM(VARNAME).EQ.'MODEL.AM3X') THEN
          VALEUR(1:INST%AM3%X%DIM1*INST%AM3%X%DIM2) =
     &       INST%AM3%X%R(1:INST%AM3%X%DIM1*INST%AM3%X%DIM2)
     ...
     &       INST%BM1%D%R(1:SIZE(INST%BM1%D%R))
        ELSE IF(TRIM(VARNAME).EQ.'MODEL.BM1X') THEN
          VALEUR(1:INST%BM1%X%DIM1*INST%BM1%X%DIM2) =
     &       INST%BM1%X%R(1:INST%BM1%X%DIM1*INST%BM1%X%DIM2)
     ...
     &       INST%BM2%D%R(1:SIZE(INST%BM2%D%R))
        ELSE IF(TRIM(VARNAME).EQ.'MODEL.BM2X') THEN
          VALEUR(1:INST%BM2%X%DIM1*INST%BM2%X%DIM2) =
     &       INST%BM2%X%R(1:INST%BM2%X%DIM1*INST%BM2%X%DIM2)
     ...
     &       INST%CM1%D%R(1:SIZE(INST%CM1%D%R))
        ELSE IF(TRIM(VARNAME).EQ.'MODEL.CM1X') THEN
          VALEUR(1:INST%CM1%X%DIM1*INST%CM1%X%DIM2) =
     &       INST%CM1%X%R(1:INST%CM1%X%DIM1*INST%CM1%X%DIM2)
     ...
     &       INST%CM2%D%R(1:SIZE(INST%CM2%D%R))
        ELSE IF(TRIM(VARNAME).EQ.'MODEL.CM2X') THEN
          VALEUR(1:INST%CM2%X%DIM1*INST%CM2%X%DIM2) =
     &       INST%CM2%X%R(1:INST%CM2%X%DIM1*INST%CM2%X%DIM2)
     ...
     &       INST%A23%D%R(1:SIZE(INST%A23%D%R))
        ELSE IF(TRIM(VARNAME).EQ.'MODEL.A23X') THEN
          VALEUR(1:INST%A23%X%DIM1*INST%A23%X%DIM2) =
     &       INST%A23%X%R(1:INST%A23%X%DIM1*INST%A23%X%DIM2)
     ...
     &       INST%A32%D%R(1:SIZE(INST%A32%D%R))
        ELSE IF(TRIM(VARNAME).EQ.'MODEL.A32X') THEN
          VALEUR(1:INST%A32%X%DIM1*INST%A32%X%DIM2) =
     &       INST%A32%X%R(1:INST%A32%X%DIM1*INST%A32%X%DIM2)
...
!
     ...
     &    VALEUR(1:INST%MESH%YNEBOR%DIM1)
        ...
        ELSE IF(TRIM(VARNAME).EQ.'MODEL.WATERDEPTHN') THEN
          INST%HN%R(1:INST%HN%DIM1) = VALEUR(1:INST%HN%DIM1)   
        ELSE IF(TRIM(VARNAME).EQ.'MODEL.INCWATERDEPTH') THEN
...
!
        ...
        ELSE IF(TRIM(VARNAME).EQ.'MODEL.IKLE')THEN      
          !!! Be carreful since api_module.py reshape is done in python
          !!!   and c convention, a transpose operator is used:
          !!!   dim1 become dim2 and inversely 
        ...
        ELSE IF(TRIM(VARNAME).EQ.'MODEL.AM1X') THEN
          DIM1 = INST%AM1%X%DIM2
          DIM2 = INST%AM1%X%DIM1
        ELSE IF(TRIM(VARNAME).EQ.'MODEL.AM2D') THEN
          DIM1 = INST%AM2%D%DIM1
        ELSE IF(TRIM(VARNAME).EQ.'MODEL.AM2X') THEN
          DIM1 = INST%AM2%X%DIM2
          DIM2 = INST%AM2%X%DIM1
        ELSE IF(TRIM(VARNAME).EQ.'MODEL.AM3D') THEN
          DIM1 = INST%AM3%D%DIM1
        ELSE IF(TRIM(VARNAME).EQ.'MODEL.AM3X') THEN
          DIM1 = INST%AM3%X%DIM2
          DIM2 = INST%AM3%X%DIM1
        ELSE IF(TRIM(VARNAME).EQ.'MODEL.BM1D') THEN
          DIM1 = INST%BM1%D%DIM1
        ELSE IF(TRIM(VARNAME).EQ.'MODEL.BM1X') THEN
          DIM1 = INST%BM1%X%DIM2
          DIM2 = INST%BM1%X%DIM1
        ELSE IF(TRIM(VARNAME).EQ.'MODEL.BM2D') THEN
          DIM1 = INST%BM2%D%DIM1
        ELSE IF(TRIM(VARNAME).EQ.'MODEL.BM2X') THEN
          DIM1 = INST%BM2%X%DIM2
          DIM2 = INST%BM2%X%DIM1
        ELSE IF(TRIM(VARNAME).EQ.'MODEL.CM1D') THEN
          DIM1 = INST%CM1%D%DIM1
        ELSE IF(TRIM(VARNAME).EQ.'MODEL.CM1X') THEN
          DIM1 = INST%CM1%X%DIM2
          DIM2 = INST%CM1%X%DIM1
        ELSE IF(TRIM(VARNAME).EQ.'MODEL.CM2D') THEN
          DIM1 = INST%CM2%D%DIM1
        ELSE IF(TRIM(VARNAME).EQ.'MODEL.CM2X') THEN
          DIM1 = INST%CM2%X%DIM2
          DIM2 = INST%CM2%X%DIM1
        ELSE IF(TRIM(VARNAME).EQ.'MODEL.A23D') THEN
          DIM1 = INST%A23%D%DIM1
        ELSE IF(TRIM(VARNAME).EQ.'MODEL.A23X') THEN
          DIM1 = INST%A23%X%DIM2
          DIM2 = INST%A23%X%DIM1
        ELSE IF(TRIM(VARNAME).EQ.'MODEL.A32D') THEN
          DIM1 = INST%A32%D%DIM1
        ELSE IF(TRIM(VARNAME).EQ.'MODEL.A32X') THEN
          DIM1 = INST%A32%X%DIM2
          DIM2 = INST%A32%X%DIM1
        ELSE IF(TRIM(VARNAME).EQ.'MODEL.CV1') THEN
          DIM1 = INST%CV1%DIM1
        ELSE IF(TRIM(VARNAME).EQ.'MODEL.CV2') THEN
          DIM1 = INST%CV2%DIM1
...
!
     ...
     &      'NUMBER OF FIRST TIME STEP FOR GRAPHIC PRINTOUTS'
          ...
          I = I + 1
          VNAME_T2D(I) = 'MODEL.WATERDEPTHN'
          VINFO_T2D(I) = 'WATER DEPTH AT PREVIOUS TIME STEP'
          I = I + 1
          VNAME_T2D(I) = 'MODEL.X'

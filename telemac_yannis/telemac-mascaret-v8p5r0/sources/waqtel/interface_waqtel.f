...
!
     ...
     &   ZPROP,T1,T21,T22,T23,T3,T4,T5,T6,T7,T8,T9,T10,T11,T12,UN,VN,
     &   DT)
        USE BIEF_DEF
        IMPLICIT NONE
      ...
      TYPE(BIEF_OBJ)   , INTENT(INOUT) :: T10,T11,T12,T22,T23
        END SUBROUTINE
      END INTERFACE
!
!-----------------------------------------------------------------------
...
!
      INTERFACE
        SUBROUTINE CALCS3D_MICROPOLV (NPOIN2,NPLAN,TN,TEXP,
     &        TIMP,ZPROP,CF,UN,VN,T2_1,T2_2,T2_3,T2_4,T3_1,T3_2,T3_3)
        USE BIEF_DEF
        IMPLICIT NONE
...
!
     ...
     & T1,T2,T3,T4,T5,T6,T7,T8,T9,T10,T11,T12,T21,T22,T23,T24,
     & PATMOS,DIMM,NPLAN,
     & LATIT,LONGIT,AT,MARDAT,MARTIM,ZPROP,DT,RHO)
      ...
      TYPE(BIEF_OBJ)   , INTENT(INOUT) :: T21,T22,T23,T24

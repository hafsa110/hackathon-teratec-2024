...
!  SATURATION VAPOUR PRESSURE (MAGNUS TETENS)
      Q_SAT_EAU  = EXP(LOG(10.D0)*7.5D0*TREEL/(TREEL+237.3D0)+0.7858D0)
      Q_SAT_AIR  = EXP(LOG(10.D0)*7.5D0*TAIR/(TAIR+237.3D0)+0.7858D0)
!
!  AIR DENSITY : IDEAL GAZ LAW
      ROAIR =    PATM*100.D0/(287.D0*(TAIR+273.15D0))
     &      - 1.32D-3*HREL*Q_SAT_AIR/(TAIR+273.15D0)
!
!  HUMIDITY

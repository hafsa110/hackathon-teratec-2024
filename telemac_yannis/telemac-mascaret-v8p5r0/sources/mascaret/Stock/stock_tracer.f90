...
!***********************************************************************
   ...
   ! ------------------------------                             
   if( OptionSto == STOCKAGE_LISTE_SECTION .or. OptionSto == STOCKAGE_SECTION_AV_AM_SING) then
   ...
   select case( FormatResu )
      ...
      if( OptionSto /= STOCKAGE_LISTE_SECTION .and. OptionSto /= STOCKAGE_SECTION_AV_AM_SING ) then

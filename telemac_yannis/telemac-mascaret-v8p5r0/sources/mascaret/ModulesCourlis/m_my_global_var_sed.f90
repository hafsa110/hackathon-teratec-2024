...
!  real(DOUBLE) :: fracH = 0.05D0                   ! MS2018 ==> devient un mot-cle
  ...
  logical      :: tau_option                       ! shear stress computation option
  ...
  integer      :: bedload_scheme                   ! numerical for bedload transport
  integer      :: fvcell                           ! finite volume control cell definition

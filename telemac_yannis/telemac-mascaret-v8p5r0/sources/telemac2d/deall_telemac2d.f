...
!
      ...
      ENDIF
      CALL BIEF_DEALLOBJ(ZRL   )
      CALL BIEF_DEALLOBJ(CSO2  )
...
!
      ...
      CALL BIEF_DEALLOBJ(VISCSA)
      CALL BIEF_DEALLOBJ(NUN   )
      CALL BIEF_DEALLOBJ(NUTILD)
      CALL BIEF_DEALLOBJ(WDIST )
      CALL BIEF_DEALLOBJ(NUBOR )
      ...
      CALL BIEF_DEALLOBJ(COSDIR)
      CALL BIEF_DEALLOBJ(SINDIR)
      CALL BIEF_DEALLOBJ(SURFROL)
      CALL BIEF_DEALLOBJ(SURFDIS)            
...
!
      IF(DEJALU_BREACH) THEN
        ...
        CALL BIEF_DEALLOBJ(THRHEAD)
        CALL BIEF_DEALLOBJ(NUMRIV)
        CALL BIEF_DEALLOBJ(NUMFLP)
        DEJALU_BREACH = .FALSE.
      ENDIF
      !

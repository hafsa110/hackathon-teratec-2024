...
!!       (1.Offshore sediment transport and equilibrium beach profiles.
!!       Technical report, Delft University, 1976. See pg.211.
!!       2.Predictive equations regarding coastal transports.
!!       Coastal Engineering, 1976. See 2.4.4)
!
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
!       KS : NIKURADSE COEFFICIENT (TOTAL FRICTION)
        ...
        IF(AW/KS.GT.1.59D0) THEN
          FW(I)=EXP(-5.977D0+5.213D0*(AW/KS)**(-0.194D0))
        ELSE
          FW(I)=0.3D0
        ENDIF

...
!-----------------------------------------------------------------------
     ...
     &           0)
      ...
      IF(KSCALC) THEN
        CALL BIEF_ALLVEC(1,KS_T0 , 'KS_T0 ', IELMT, 1, 2,MESH) ! KS FROM TELEMAC AT FIRST TIME STEP
      ELSE
        CALL BIEF_ALLVEC(1,KS_T0 , 'KS_T0 ', 0 , 1 , 0 ,MESH)
      ENDIF
      ...
      CALL BIEF_ALLVEC(1,SURF_ENG, 'SURENG', IELMT, 1, 2,MESH)
      CALL BIEF_ALLVEC(1,SURF_DIS, 'SURDIS', IELMT, 1, 2,MESH)

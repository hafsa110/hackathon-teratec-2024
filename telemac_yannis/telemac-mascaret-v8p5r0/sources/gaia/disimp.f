...
!!        discharge in kg/m/s, the integral of Q2BOR on the boundary
!!        QBOR is multiplied by a constant to get the correct discharge
!!        Q
!
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
!>@param[in,out] QBOR    The resulting discharge in kg/s
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!
      USE BIEF
!
...
!         ZERO FLUX: WARNING MESSAGE
          IF(ABS(Q).GT.1.D-10) THEN
            WRITE(LU,31) IFRLIQ
31          FORMAT(1X,'DISIMP : PROBLEM ON BOUNDARY NUMBER ',1I6,/,
     &      1X,

...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!
      USE INTERFACE_GAIA,EX_BEDLOAD_DIBWAT => BEDLOAD_DIBWAT
      USE BIEF
...
!
!     SLOPE EFFECT: SOULBY FORMULATION OR APSLEY & STANSBY
!
      IF(SLOPEFF.EQ.2.OR.SLOPEFF.EQ.3) THEN
!       CHANGING BOUNDS (SHIELDS_CRIT) PARAMETER IN CALCULATION OF
!       OMEGACRIT

...
!
      IF(.NOT.NONHYD) THEN
        IF( LT.EQ.0.AND..NOT.DEBU.AND.
     &     (ITURBV.EQ.3.OR.ITURBH.EQ.3.OR.ITURBV.EQ.7.OR.ITURBH.EQ.7))
     &    THEN
!         NOTHING DONE AS W READ IN PREVIOUS COMPUTATION FILE
!         IF W NOT PRESENT, CALL TO WSTARW DONE JUST AFTER PREADV
        ELSEIF(((LT/GRAPRD)*GRAPRD.EQ.LT.AND.LT.GE.GRADEB).OR.

...
!+        05/03/2023
!+        V8P5
!+   Creation from TELEMAC-2D version flusec_telemac2d.f
!
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!| BM1            |<->| WORK MATRIX
!| BM2            |<->| WORK MATRIX
...
!
      USE BIEF
      USE DECLARATIONS_TELEMAC3D, ONLY: CHAIN,LISTE_FS,DEJA_FS,NSEG_FS,
...
!
        IF(IGBEST.EQ.PT) THEN
          WRITE(LU,33)
33        FORMAT(1X,'FLUSEC_TELEMAC3D : ALGORITHM FAILED')
          CALL PLANTE(1)
          STOP
        ELSE
          PT = IGBEST
          ...
          IF(ISEG.GT.NSEMAX) THEN
            WRITE(LU,*) 'FLUSEC_TELEMAC3D: TOO MANY SEGMENTS IN A   '

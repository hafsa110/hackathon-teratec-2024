...
!           CV 0< CORRECTION <1
            ...
            WCHU(I)  = WCHU(I)*CORR
          ELSEIF(HIND_TYPE.EQ.0) THEN
            WRITE(LU,*) 'USER SUBROUTINE FOR HINDERING'
            CALL USER_HINDERING_FORMULA(WCHU,C,CINI,CGEL)
          ELSE
            WRITE(LU,*) 'HINDERED SETTLING FORMULA MUST BE 0, 1 OR 2'
            CALL PLANTE(1)
            STOP
          ENDIF
        ENDIF

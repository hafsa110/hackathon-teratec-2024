...
!
      ...
      TEXTE (43) = 'O2 SAT CONC     MGO2/L          '
      TEXTE (44) = 'O2 SAT PERC     PERCENT         '
!
...
!
      ...
      TEXTPR (43) = 'O2 SAT CONC     MGO2/L          '
      TEXTPR (44) = 'O2 SAT PERC     PERCENT         '
!
!-----------------------------------------------------------------------
!
!  FRANCAIS OU AUTRE
...
!
      ...
      TEXTE (41) = 'W SURFACE       M/S             '
      TEXTE (42) = 'M SURFACE       M/S             '
      TEXTE (43) = 'CONC SAT O2     MGO2/L          '
      TEXTE (44) = 'POURCENT SAT O2 PERCENT         '
!
...
!
      ...
      TEXTPR (41) = 'W SURFACE       M/S             '
      TEXTPR (42) = 'M SURFACE       M/S             '
      TEXTPR (43) = 'CONC SAT O2     MGO2/L          '
      TEXTPR (44) = 'POURCENT SAT O2 PERCENT         '
!
!-----------------------------------------------------------------------
!
      ENDIF

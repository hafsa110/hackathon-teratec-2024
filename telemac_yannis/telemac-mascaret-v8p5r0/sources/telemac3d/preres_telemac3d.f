...
!=======================================================================
!
      IF(LEO.AND.SORG2D(43)) THEN
        CALL VERMOY(T2_18%R,T2_18%R,CSO2%R,CSO2%R,1,Z,
...
!
!=======================================================================
! COMPUTES PERCENTAGE OF OXYGEN SATURATION (3D AND/OR VERTICAL AVERAGE)
!=======================================================================
!
      IF(LEO.AND.(SORG3D(33).OR.SORG2D(44))) THEN
        DO I=1,NPOIN3
          T3_04%R(I) = TA%ADR(IND_O2)%P%R(I)/CSO2%R(I)*100.D0
        ENDDO
        IF(SORG2D(44)) THEN
          CALL VERMOY(T2_19%R,T2_19%R,T3_04%R,T3_04%R,1,Z,

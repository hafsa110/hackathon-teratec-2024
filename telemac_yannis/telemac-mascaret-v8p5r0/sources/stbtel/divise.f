...
!***********************************************************************
!
!brief    dividing all elements in 4 elements
!
!-----------------------------------------------------------------------
!| X,Y            |<->| Mesh coordinates
!| IKLE           |<->| Connectivity table
!| NCOLOR         |<->| Array of node colours
!| NPOIN          |<->| New number of nodes after split
!| NELEM          |<->| New number of elements after split
!| NELMAX         |<->| Effective sizes of relevant arrays
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!
      USE BIEF

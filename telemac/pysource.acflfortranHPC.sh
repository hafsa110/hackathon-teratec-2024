...
export F90=/tools/acfl/arm-linux-compiler-23.10_AmazonLinux-2/bin/armflang
...
export USETELCFG=acflfortranHPC
# Path to this file
export SOURCEFILE=$HOMETEL/../pysource.acflfortranHPC.sh
### Python

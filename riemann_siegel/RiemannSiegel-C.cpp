...
static inline double Z(double t, int n)
//*************************************************************************
...
//*************************************************************************
{
	...
	R = R + C_mem[0] * pow(2.0*PI/t, ((double) 0)*0.5);
	R = R + C_mem[1] * pow(2.0*PI/t, ((double) 1)*0.5);
	R = R + C_mem[2] * pow(2.0*PI/t, ((double) 2)*0.5);
	R = R + C_mem[3] * pow(2.0*PI/t, ((double) 3)*0.5);
	R = R + C_mem[4] * pow(2.0*PI/t, ((double) 4)*0.5);
